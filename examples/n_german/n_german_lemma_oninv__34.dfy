...
method n_RecvReqSinv__34_0(Cache_State:array<CACHE_STATE>,   Chan1_Cmd:array<MSG_CMD>,  CurCmd:array<MSG_CMD>,  CurPtr:array<NODE>, InvSet:array<boolean>,   ShrSet:array<boolean>,
N0:nat,i:nat,
...
ensures   (!((InvSet[p__Inv2] == true) && (Cache_State[p__Inv0] == E)))
modifies Chan1_Cmd
modifies CurCmd
modifies CurPtr
modifies InvSet
...
method n_RecvReqSinv__34_1(Cache_State:array<CACHE_STATE>,   Chan1_Cmd:array<MSG_CMD>,  CurCmd:array<MSG_CMD>,  CurPtr:array<NODE>, InvSet:array<boolean>,   ShrSet:array<boolean>,
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0
...
method n_RecvReqSinv__34_2(Cache_State:array<CACHE_STATE>,   Chan1_Cmd:array<MSG_CMD>,  CurCmd:array<MSG_CMD>,  CurPtr:array<NODE>, InvSet:array<boolean>,   ShrSet:array<boolean>,
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0
...
method n_RecvReqEinv__34_0(Cache_State:array<CACHE_STATE>,   Chan1_Cmd:array<MSG_CMD>,  CurCmd:array<MSG_CMD>,  CurPtr:array<NODE>, InvSet:array<boolean>,   ShrSet:array<boolean>,
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0
...
method n_RecvReqEinv__34_1(Cache_State:array<CACHE_STATE>,   Chan1_Cmd:array<MSG_CMD>,  CurCmd:array<MSG_CMD>,  CurPtr:array<NODE>, InvSet:array<boolean>,   ShrSet:array<boolean>,
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0
...
method n_RecvReqEinv__34_2(Cache_State:array<CACHE_STATE>,   Chan1_Cmd:array<MSG_CMD>,  CurCmd:array<MSG_CMD>,  CurPtr:array<NODE>, InvSet:array<boolean>,   ShrSet:array<boolean>,
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0
...
requires p__Inv0!=p__Inv2&&p__Inv2<N0&& p__Inv0<N0
requires i==p__Inv0
requires (!((InvSet[p__Inv2] == true) && (Cache_State[p__Inv0] == E)))//2
requires ((Chan2_Cmd[i] == Empty) && (InvSet[i] == true) && (CurCmd[0] == ReqE)) //guard condition
ensures   (!((InvSet[p__Inv2] == true) && (Cache_State[p__Inv0] == E)))
modifies Chan2_Cmd
modifies InvSet
...
method n_SendReqE__part__1inv__34_0(Cache_State:array<CACHE_STATE>,    Chan1_Cmd:array<MSG_CMD>, InvSet:array<boolean>, 
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0
...
requires 0<=i<N0
requires p__Inv0!=p__Inv2&&p__Inv2<N0&& p__Inv0<N0
requires (!((InvSet[p__Inv2] == true) && (Cache_State[p__Inv0] == E)))//statement has nothing with prop--it guranttee itself
...
method n_SendReqE__part__0inv__34_0(Cache_State:array<CACHE_STATE>,    Chan1_Cmd:array<MSG_CMD>, InvSet:array<boolean>, 
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0
...
method n_SendReqSinv__34_0(Cache_State:array<CACHE_STATE>,    Chan1_Cmd:array<MSG_CMD>, InvSet:array<boolean>, 
N0:nat,i:nat,
p__Inv0:nat,p__Inv2:nat)
requires N0>0

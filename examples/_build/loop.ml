...
let invariant = 
    ...
    let params = [] in 
    let formula = (andList [(uif "<=" [var (global "c");var (global "N")]);eqn (global "c") (uif "*" (uif "*" (global "n") (global "n")) global "n");eqn (global "k") (uif "+" (uif "+" (uif "*" (uif "*" (const (intc 3) (global "n"))) (global "n")) (uif "*" (const (intc 3) (global "n")))) (const (intc 1)));eqn (global "m") ((uif "+" (uif "*" (const (intc 6) global "n")) (const intc 6)))]) in
...
(* uif "+" (uif "+" (uif "*" (uif "*" (const (intc 3) (global "n"))) (global "n")) (uif "*" (const (intc 3) (global "n")))) (const (intc 1)) *)
(* (uif "+" (uif "*" (const (intc 6) global "n")) (const intc 6)) *)
...
requires  p__Inv2<N0
requires i!=p__Inv2
requires (!((home_sharer_list[p__Inv2] == false) && (cache[p__Inv2] == exclusive)))//2
requires ((home_current_command[0] == req_exclusive) && (home_sharer_list[i] == true)) //guard condition
ensures   (!((home_sharer_list[p__Inv2] == false) && (cache[p__Inv2] == exclusive)))
modifies cache
modifies home_exclusive_granted
...
method n_t5inv__2_2(cache:array<cacheType>,    home_current_client:array<client>,  home_current_command:array<channelType>, home_exclusive_granted:array<boolean>, home_sharer_list:array<boolean>,
N0:nat,i:nat,
p__Inv2:nat)
requires N0>0
...
method n_t6inv__2_0(cache:array<cacheType>,    home_current_client:array<client>,  home_current_command:array<channelType>, home_exclusive_granted:array<boolean>, home_sharer_list:array<boolean>,   
N0:nat,i:nat,
p__Inv2:nat)
requires N0>0
...
method n_t6inv__2_1(cache:array<cacheType>,    home_current_client:array<client>,  home_current_command:array<channelType>, home_exclusive_granted:array<boolean>, home_sharer_list:array<boolean>,   
N0:nat,i:nat,
p__Inv2:nat)
requires N0>0
...
method n_t6inv__2_2(cache:array<cacheType>,    home_current_client:array<client>,  home_current_command:array<channelType>, home_exclusive_granted:array<boolean>, home_sharer_list:array<boolean>,   
N0:nat,i:nat,
p__Inv2:nat)
requires N0>0
...
method n_t2inv__2_0(cache:array<cacheType>,    home_current_client:array<client>,  home_current_command:array<channelType>, home_sharer_list:array<boolean>,
N0:nat,i:nat,
p__Inv2:nat)
requires N0>0
...
requires 0<=i<N0
requires  p__Inv2<N0
requires (!((home_sharer_list[p__Inv2] == false) && (cache[p__Inv2] == exclusive)))//statement has nothing with prop--it guranttee itself
...
method n_t1inv__2_0(cache:array<cacheType>,    home_current_client:array<client>,  home_current_command:array<channelType>, home_sharer_list:array<boolean>,
N0:nat,i:nat,
p__Inv2:nat)
requires N0>0
